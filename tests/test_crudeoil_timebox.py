...
def test_evening_segment_does_not_run_after_midnight() -> None:
    now = datetime(2026, 8, 13, 0, 24, tzinfo=MCX_KOLKATA)

    assert seconds_remaining(now, SessionSegment.EVENING) == 0
